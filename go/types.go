// Package savingsbonds provides a Go client for the Savings Bonds API.
//
// For more information, visit: https://apiverve.com/marketplace/savingsbonds?utm_source=go&utm_medium=readme
package savingsbonds
...
// Request contains the parameters for the Savings Bonds API.
//
// Parameters:
//   - type: string - Bond type: 'i' for I Bonds, 'ee' for EE Bonds. Omit for both.
type Request struct {
...
// ResponseData contains the data returned by the Savings Bonds API.
type ResponseData struct {
	IBonds IBondsData `json:"iBonds"`
	EeBonds EeBondsData `json:"eeBonds"`
	Recommendation string `json:"recommendation"`
	RecommendationReason string `json:"recommendationReason"`
	NextRateChange string `json:"nextRateChange"`
	LastUpdated string `json:"lastUpdated"`
}

// IBondsData represents the iBonds object.
type IBondsData struct {
...
// EeBondsData represents the eeBonds object.
type EeBondsData struct {
	CurrentRate float64 `json:"currentRate"`
	GuaranteedDoubling string `json:"guaranteedDoubling"`
	PurchaseLimit int `json:"purchaseLimit"`
}
