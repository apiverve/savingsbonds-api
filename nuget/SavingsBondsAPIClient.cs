...
namespace APIVerve.API.SavingsBonds
{
    ...
    /// <summary>
    /// Client for the SavingsBonds API
    /// </summary>
    public class SavingsBondsAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/savingsbonds";
        ...
        {
            { "type", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public SavingsBondsAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SavingsBondsAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SavingsBondsAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, SavingsBondsQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(SavingsBondsQueryOptions options)
        {
        ...
        public ResponseObj Execute(SavingsBondsQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(SavingsBondsQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(SavingsBondsQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(SavingsBondsQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(SavingsBondsQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(SavingsBondsQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(SavingsBondsQueryOptions options)
        {
