...
const (
	baseURL        = "https://api.apiverve.com/v1/savingsbonds"
	defaultTimeout = 30 * time.Second
)

// Client is the Savings Bonds API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Savings Bonds API client.
...
// Execute makes a request to the Savings Bonds API with typed parameters.
//
