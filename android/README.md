...
```gradle
dependencies {
    implementation 'com.github.apiverve:savingsbonds-api:1.1.14'
}
```
...
SavingsBondsAPIClient client = new SavingsBondsAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/savingsbonds](https://docs.apiverve.com/ref/savingsbonds)
...
- **Documentation:** [https://docs.apiverve.com/ref/savingsbonds](https://docs.apiverve.com/ref/savingsbonds)
- **Issues:** [GitHub Issues](https://github.com/apiverve/savingsbonds-api/issues)
